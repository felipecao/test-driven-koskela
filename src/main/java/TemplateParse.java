...
// TODO we should streamline this class by skipping the string-to-segment object conversion
public class TemplateParse
{
    ...
    public List<Segment> parseSegments(String template)
    {
        ...
        List<String> strings = parse(template); // TODO remove this list and use only segments
